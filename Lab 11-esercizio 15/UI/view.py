...
class View(ft.UserControl):
    def __init__(self, page: ft.Page):
        ...
        # Pagina
        self._page = page
        self._page.title = "Facsimile 15 - Chinook Generi"
    ...
    def load_interface(self):
        # Titolo
        self._title = ft.Text(
            "Facsimile 15 - Chinook: Generi ordinati per fatturato",
            color="blue",
            size=24
        )
        ...
        # Dropdown genere di partenza per il punto 2
        self._ddGenereStart = ft.Dropdown(
            label="Genere di partenza",
            width=350
        )
