...
class View(ft.UserControl):
    def __init__(self, page: ft.Page):
        ...
        # Pagina
        self._page = page
        self._page.title = "Facsimile 12 - Chinook MediaType"
    ...
    def load_interface(self):
        # Titolo
        self._title = ft.Text(
            "Facsimile 12 - Chinook: MediaType co-acquistati",
            color="blue",
            size=24
        )
        ...
        # Dropdown MediaType di partenza
        self._ddMediaTypeStart = ft.Dropdown(
            label="MediaType di partenza",
            width=350
        )
        ...
        # Riempio il dropdown iniziale dei paesi
        self._controller.fillDDPaesi()
